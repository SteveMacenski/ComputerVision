...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights',{{0.01*randn(5,5,3,32, 'single'), zeros(1, 32, 'single')}}, ...%{{ net_first.layers{1}.weights{1},net_first.layers{1}.weights{2}}},... %{{1e-4*randn(5,5,3,32, 'single'), zeros(1, 32, 'single')}}, ...
                           'learningRate',[1,2],...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 2,...
...
% 4 conv2
net.layers{end+1} = struct('type', 'conv', ...
                           'weights',{{0.03*randn(5,5,32,32, 'single'), zeros(1, 32, 'single')}}, ... %{{net_first.layers{4}.weights{1},net_first.layers{4}.weights{2} }},... %{{0.01*randn(7,7,32,32, 'single'), zeros(1, 32, 'single')}}, ...
                           'learningRate',[1,2],...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 0,...
...
net.layers{end+1} = struct('type', 'pool', ...
 ...
 % 7 conv3
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{0.03*randn(3,3,32,32, 'single'), zeros(1, 32, 'single')}}, ...%{{net_first.layers{7}.weights{1},net_first.layers{7}.weights{2} }},... %{{0.01*randn(3,3,32,32, 'single'), zeros(1, 32, 'single')}}, ...
                           'learningRate',[1,2],...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 0,...
...
% 10 conv4
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{0.1*randn(1,1,32,100, 'single'), zeros(1, 100, 'single')}}, ...%{{net_first.layers{10}.weights{1},net_first.layers{10}.weights{2} }},... %{{0.1*randn(2,2,32,100, 'single'), zeros(1, 100, 'single')}}, ...
                           'learningRate',[1,2],...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 0,...
