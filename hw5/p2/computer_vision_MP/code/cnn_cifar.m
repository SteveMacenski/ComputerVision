...
net.layers{end+1} = struct('type', 'pool', ...
 ...
 % 15 conv7
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{0.01*randn(3,3,170,100, 'single'), zeros(1, 100, 'single')}}, ...%{{net_first.layers{7}.weights{1},net_first.layers{7}.weights{2} }},... %{{0.01*randn(3,3,32,32, 'single'), zeros(1, 32, 'single')}}, ...
                           'learningRate',[1,2],...
                           'dilate', 1, ...
                           'stride', 1, ...
                           'pad', 0,...
